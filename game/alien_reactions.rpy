...
label engine_piston:
    ...
    "The Alien is absolutely thrilled with this new melee weapon."
    play sound answercorrect
    show alien shocked
...
label floppy_disk:
    ...
    play sound answercorrect
    show alien happy
    a "I will now download your planetary defenses—"
    play sound answerwrong
    show alien shocked
    a "wait. ERROR? SYSTEM PURGE?! You uploaded a lethal techno-virus into my mainframe! We die together!"
    $ change_mood(-100)
    jump chapter1
...
label disembodied_head:
    ...
    play sound answercorrect
    show alien shocked
    a "This deity... it does not blink. It knows no fear..."
    play sound answerwrong
    show alien angry
    a "IT IS JUDGING MY SOUL! You summoned a dark god to smite me! I MUST NEUTRALIZE THE SUMMONER!"
    $ change_mood(-100)
    jump chapter1